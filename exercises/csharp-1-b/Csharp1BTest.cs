...
public class StoreTest
{
    ...
    public void NonEmptyQueuesWithMiddleQueueHasMinimalWaitingTime() =>
        Assert.Equal(2, Store.QueueWithMinimalWaitingTime(customersInQueue1: 1, customersInQueue2: 2, customersInQueue3: 6));
    
    [Fact]
    public void NonEmptyQueuesWithSlowestQueueHasMinimalWaitingTime() =>
        Assert.Equal(1, Store.QueueWithMinimalWaitingTime(customersInQueue1: 2, customersInQueue2: 6, customersInQueue3: 11));
}